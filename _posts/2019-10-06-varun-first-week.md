...
>
    * **Solution** - Turns out the file extension was ![](/Images/Week01/Html.png) which didnt play well with markdown. Renamed the file extension from .html to .md ![](/Images/Week01/md.png) and then it started working
>
